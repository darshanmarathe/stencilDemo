const NAMESPACE = 'manotr-timeline';
const BUILD = /* manotr-timeline */ { allRenderFn: true, appendChildSlotFix: false, asyncLoading: true, asyncQueue: false, attachStyles: true, cloneNodeFix: false, cmpDidLoad: false, cmpDidRender: false, cmpDidUnload: false, cmpDidUpdate: false, cmpShouldUpdate: false, cmpWillLoad: false, cmpWillRender: false, cmpWillUpdate: false, connectedCallback: false, constructableCSS: false, cssAnnotations: true, cssVarShim: true, devTools: true, disconnectedCallback: false, dynamicImportShim: true, element: false, event: false, hasRenderFn: false, hostListener: false, hostListenerTarget: false, hostListenerTargetBody: false, hostListenerTargetDocument: false, hostListenerTargetParent: false, hostListenerTargetWindow: false, hotModuleReplacement: true, hydrateClientSide: false, hydrateServerSide: false, hydratedAttribute: false, hydratedClass: true, initializeNextTick: true, isDebug: false, isDev: true, isTesting: false, lazyLoad: true, lifecycle: false, lifecycleDOMEvents: false, member: true, method: false, mode: false, observeAttribute: false, profile: true, prop: false, propBoolean: false, propMutable: false, propNumber: false, propString: false, reflect: false, safari10: true, scoped: false, scriptDataOpts: true, shadowDelegatesFocus: false, shadowDom: false, shadowDomShim: true, slot: false, slotChildNodesFix: false, slotRelocation: false, state: false, style: false, svg: false, taskQueue: true, transformTagName: false, updatable: true, vdomAttribute: false, vdomClass: false, vdomFunctional: false, vdomKey: false, vdomListener: false, vdomPropOrAttr: false, vdomRef: false, vdomRender: false, vdomStyle: false, vdomText: false, vdomXlink: false, watchCallback: false };
        ...
        if (BUILD.style && Cstr.style) {
            ...
            if (!styles.has(scopeId)) {
                ...
                if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                    style = await __sc_import_manotr_timeline('./shadow-css-7cbc8789.js').then(m => m.scopeCss(style, scopeId, false));
                }
...
const loadModule = (cmpMeta, hostRef, hmrVersionId) => {
    ...
    return __sc_import_manotr_timeline(
...
const __filename$1 = '/manotr\work\widgets\timeline-wc-stencil\manotr-timeline\node_modules\@stencil\core\internal\client';
...
const IS_DENO_ENV$1 = typeof Deno !== 'undefined';
const IS_NODE_ENV$1 = !IS_DENO_ENV$1 &&
    typeof global$1 !== 'undefined' &&
    typeof require === 'function' &&
    !!global$1.process &&
    typeof __filename$1 === 'string' &&
    (!global$1.origin || typeof global$1.origin !== 'string');
const IS_DENO_WINDOWS_ENV$1 = IS_DENO_ENV$1 && Deno.build.os === 'windows';
const getCurrentDirectory$1 = IS_NODE_ENV$1 ? browser$1.cwd : IS_DENO_ENV$1 ? Deno.cwd : () => '/';
const exit$1 = IS_NODE_ENV$1 ? browser$1.exit : IS_DENO_ENV$1 ? Deno.exit : noop$2;
...
const patchEsm = () => {
    ...
    if (BUILD.cssVarShim && !(CSS && CSS.supports && CSS.supports('color', 'var(--c)'))) {
        // @ts-ignore
        return __sc_import_manotr_timeline(/* webpackChunkName: "polyfills-css-shim" */ './css-shim-219d568c.js').then(() => {
...
const patchBrowser = () => {
    ...
    if (!BUILD.safari10 && importMeta !== '') {
        ...
        if (BUILD.dynamicImportShim && !win.customElements) {
            ...
            // @ts-ignore
            return __sc_import_manotr_timeline(/* webpackChunkName: "polyfills-dom" */ './dom-f0048d56.js').then(() => opts);
        }
    }
...
export { patchEsm as a, bootstrapLazy as b, globalScripts as g, patchBrowser as p };
